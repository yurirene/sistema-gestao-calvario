            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            @if (!isset($model))
                            {!! Form::open(['url' => route('frequencia-dominical.store'), 'method' => 'POST']) !!}
                            @else
                            {!! Form::model($model, [
                                    'url' => route('frequencia-dominical.update', $model->id),
                                    'method' => 'PUT'
                            ]) !!}
                            @endif
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('visitantes', isset($model) ? null : 0, [
                                                'class' => 'form-control',
                                                'step' => '1',
                                                'min' => '0',
                                                'autocomplete' => 'off'
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('visitantes_criancas', isset($model) ? null : 0, [
                                            'class' => 'form-control',
                                            'step' => '1',
                                            'min' => '0',
                                            'autocomplete' => 'off'
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('nome_visitantes', null, [
                                            'class' => 'form-control',
                                            'autocomplete' => 'off',
                                            'rows' => 3
                                        ]) !!}
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input type="checkbox" name="is_culto" class="form-check-input" id="culto"
                                            {{ isset($model) && $model->is_culto ? 'checked' : '' }}>
                            ...
                            <a href="{{ route('frequencia-dominical.index') }}" class="btn btn-default">
